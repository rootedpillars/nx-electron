...
exports.getBaseWebpackPartial = exports.OUT_FILENAME_TEMPLATE = exports.DEFAULT_APPS_DIR = exports.INDEX_OUTPUT_FILENAME = exports.MAIN_OUTPUT_FILENAME = void 0;
    ...
    const webpackConfig = {
        ...
        plugins: [
            ...
            new webpack_1.DefinePlugin({
                __BUILD_VERSION__: ((_c = options.extraMetadata) === null || _c === void 0 ? void 0 : _c.version) || JSON.stringify(require((0, path_1.join)(options.root, 'package.json')).version),
