...
function executor(rawOptions, context) {
    ...
    if (normalizedOptions.generatePackageJson) {
        const packageJson = (0, js_1.createPackageJson)(context.projectName, projGraph, Object.assign(Object.assign({}, normalizedOptions), { isProduction: true }));
        (0, devkit_1.writeJsonFile)(`${normalizedOptions.outputPath}/package.json`, packageJson);
        const pm = (0, devkit_1.detectPackageManager)();
        const lockFile = (0, js_1.createLockFile)(packageJson, projGraph, (0, devkit_1.detectPackageManager)());
        const lockFileName = (0, js_1.getLockFileName)(pm);
        (0, fs_1.writeFileSync)(`${normalizedOptions.outputPath}/${lockFileName}`, lockFile, {
            encoding: 'utf8',
        });
    }
